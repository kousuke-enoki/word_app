...
// HasExternalAuths applies the HasEdge predicate on the "external_auths" edge.
func HasExternalAuths() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasExternalAuthsWith applies the HasEdge predicate on the "external_auths" edge with a given conditions (other predicates).
