...
func (ucq *UserConfigQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (ucq *UserConfigQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(userconfig.Table, userconfig.Columns, sqlgraph.NewFieldSpec(userconfig.FieldID, field.TypeInt))
	_spec.From = ucq.sql
