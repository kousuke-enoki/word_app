...
// MyPageHandler implements interfaces.UserHandler.
func (_m *UserClient) MyPageHandler() gin.HandlerFunc {
	panic("unimplemented")
}

// SignInHandler implements interfaces.UserHandler.
func (_m *UserClient) SignInHandler() gin.HandlerFunc {
	panic("unimplemented")
}

// SignUpHandler implements interfaces.UserHandler.
func (_m *UserClient) SignUpHandler() gin.HandlerFunc {
	panic("unimplemented")
}
