...
func (_mock *MockTxManager) WithTx(ctx context.Context, f func(ctx context.Context) error) error {
...
func (_e *MockTxManager_Expecter) WithTx(ctx interface{}, f interface{}) *MockTxManager_WithTx_Call {
	return &MockTxManager_WithTx_Call{Call: _e.mock.On("WithTx", ctx, f)}
}

func (_c *MockTxManager_WithTx_Call) Run(run func(ctx context.Context, f func(ctx context.Context) error)) *MockTxManager_WithTx_Call {
...
func (_c *MockTxManager_WithTx_Call) RunAndReturn(run func(ctx context.Context, f func(ctx context.Context) error) error) *MockTxManager_WithTx_Call {
	_c.Call.Return(run)
	return _c
}
