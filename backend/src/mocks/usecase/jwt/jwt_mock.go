...
func (_mock *MockAuthenticator) Authenticate(ctx context.Context, raw string) (models.Principal, error) {
	...
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, string) (models.Principal, error)); ok {
		return returnFunc(ctx, raw)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, string) models.Principal); ok {
...
//   - ctx context.Context
//   - raw string
func (_e *MockAuthenticator_Expecter) Authenticate(ctx interface{}, raw interface{}) *MockAuthenticator_Authenticate_Call {
...
func (_c *MockAuthenticator_Authenticate_Call) Return(principal models.Principal, err error) *MockAuthenticator_Authenticate_Call {
	_c.Call.Return(principal, err)
	return _c
}

func (_c *MockAuthenticator_Authenticate_Call) RunAndReturn(run func(ctx context.Context, raw string) (models.Principal, error)) *MockAuthenticator_Authenticate_Call {
	_c.Call.Return(run)
	return _c
}
