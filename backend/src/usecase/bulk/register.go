...
func NewRegisterUsecase(
	...
	return &registerUsecase{words: words, rwRead: rwRead, rwWrite: rwWrite, txm: txm, locker: locker, limits: limits}
}

func (uc *registerUsecase) Register(ctx context.Context, userID int, payload []string) (*models.BulkRegisterResponse, error) {
	...
	nameToID, err := uc.words.FindIDsByNames(ctx, norm)
	if err != nil {
		return nil, err
	}
