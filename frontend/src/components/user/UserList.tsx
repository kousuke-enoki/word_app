...
const UserList: React.FC = () => {
  ...
  // ローディング状態: API取得中はtrue、完了時にfalse
  const [loading, setLoading] = useState(true)
  // エラー状態: API取得失敗時にエラーメッセージを格納
  ...
  // 検索・ソート・ページングパラメータが変更されたら自動的に再取得
  useEffect(() => {
  ...
  return (
    <div>
      ...
      <Card className="p-4">
        ...
        {/* ローディング中はスケルトンUIを表示（統合テスト用のdata-testidを付与） */}
        {loading ? (
          <div
