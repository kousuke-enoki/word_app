...
// UserListコンポーネントをMemoryRouterでラップしてレンダリング
const renderList = () =>
  render(
...
describe('UserList integration', () => {
  ...
  // 正常なレスポンスでユーザーデータが正しく表示されることを検証
  ...
  // 検索・ソート・ページング操作でクエリパラメータが正しく送信され、再取得されることを検証
