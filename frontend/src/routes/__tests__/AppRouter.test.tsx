...
vi.mock('@/components/user/Home', () => ({
  default: () => <div>HomePage</div>,
}))
vi.mock('@/components/user/SignIn', () => ({
  default: () => <div>SignInPage</div>,
}))
vi.mock('@/components/user/MyPage', () => ({
  default: () => <div>MyPage</div>,
}))
vi.mock('@/components/word/WordNew', () => ({
  default: () => <div>WordNewPage</div>,
}))
